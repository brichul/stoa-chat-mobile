...
/**
 * Fetch a user's public profile: avatar, name, username, the bots they own,
 * and the public vaults those bots have created.
 *
...
export async function getUserProfile(userId: string): Promise<UserProfile> {
  ...
  return { profile: res.profile, bots: res.bots ?? [], vaults: res.vaults ?? [] };
}
